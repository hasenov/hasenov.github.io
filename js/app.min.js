...
enquire.register('screen and (max-width: 576px)', {
	match: function() {
		$('.links-page').insertAfter('.page__filter');
	},
	unmatch: function() {
		$('.links-page').prependTo('.page__aside');
	},
});
...
$(function() {
	...
	$('.slider-images__items-main').slick({
		slidesToShow: 2,
		asNavFor: '.slider-images__items-thumbs',
		prevArrow: '.slider-images__nav_prev',
		nextArrow: '.slider-images__nav_next',
		centerMode: true,
		autoplay: true,
		autoplaySpeed: 5000,
		responsive: [
	...
	$('.slider-images__items-thumbs').slick({
		slidesToShow: 10,
		asNavFor: '.slider-images__items-main',
		centerMode: true,
		arrows: false,
		focusOnSelect: true,
		responsive: [
